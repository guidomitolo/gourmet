...
class Consulta(models.Model):
    ...
    mail = models.EmailField(max_length=50, blank=False, null=True)
    estado_respuesta = models.CharField(max_length=15, blank=True, choices=DEVOLUCION, default=NOCONTESTADA)
